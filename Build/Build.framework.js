...
var ASM_CONSTS = {
  4523020: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4523075: ($0) => { performance.now = function() { return $0; }; },  
 4523123: ($0) => { performance.now = function() { return $0; }; },  
 4523171: () => { performance.now = Module['emscripten_get_now_backup']; }
};
